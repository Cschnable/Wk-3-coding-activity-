...
paste(Connor_mydata, 2)

#This code chunk shows me the structure 
#Such as number of columns, number of observations, 2, and 15
...
#Such as Min, 1st and 3rd q , Median, Mean, and Max
#Task: Complete the comment above
summary(Connor_mydata)
...
ggplot(NewWomen, aes(x=height, y=weight)) + 
  geom_point(shape = 15, colour = "black", fill = "white", size = 4, stroke = 7)
